...
android {
    namespace = "com.example.climap1"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.climap1"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
// This the RXJava specific for Android
    ...
    implementation("com.google.dagger:dagger-android-support:2.51") // if you use the support libraries
